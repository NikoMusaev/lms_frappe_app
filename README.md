...
Пока только скелет. Наполнение идёт задачами:

| Что | Задача |
|---|---|
| `Agent Lesson Directive` | [#6](https://github.com/NikoMusaev/lms-mcp/issues/6) |
| `Agent Learning Session`, `Agent Session Event` | [#7](https://github.com/NikoMusaev/lms-mcp/issues/7) |
| Нормализатор контента уроков | [#8](https://github.com/NikoMusaev/lms-mcp/issues/8) |
| Организации, членство, назначение курсов | [#9](https://github.com/NikoMusaev/lms-mcp/issues/9) |
